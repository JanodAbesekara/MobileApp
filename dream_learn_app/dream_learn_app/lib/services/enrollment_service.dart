...
//     var url = Uri.http('bytegroupproject.onrender.com', '/api/Enrol/getSubject', {'email': email});
//     var response = await http.get(url);

//     if (response.statusCode == 200) {
//       Map<String, dynamic> decodedJson = jsonDecode(response.body) as Map<String, dynamic>;
//       return (decodedJson['data'] as List)
//           .map((subjectMap) => Subject.fromJson(subjectMap as Map<String, dynamic>))
//           .toList();
//     } else {
//       throw Exception('Cannot get subject list: ${response.reasonPhrase}');
//     }
//   }
// }
